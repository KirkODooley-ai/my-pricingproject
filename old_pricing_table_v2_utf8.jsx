                                                                    ...
                                                                    <>
                                                                        {unmatchedNames.size > 0 && (
                                                                            <div style={{ marginBottom: '0.5rem' }}>
                                                                                <span style={{ fontWeight: 600 }}>ΓÇó {unmatchedNames.size} transactions are Unclassified.</span><br />
                                                                        ...
                                                                        {matchedToOtherTier.size > 0 && matches > 0 && (
                                                                            <div>
                                                                                <span style={{ fontWeight: 600 }}>ΓÇó Found matches in other tiers:</span><br />
                                                                                <span>{otherTierList}...</span>
                                                                            </div>
                                                                        )}
                                                                        {matchedToOtherTier.size === 0 && unmatchedNames.size === 0 && (
                                                                            <span>ΓÇó All customers matched but fall into different tiers or groups.</span>
                                                                        )}
                                                                    </>
                                                                )
                                                            })()}
